...
void SetNESDeemph(uint8 d, int force)
{
 ...
 static uint16 btmul[7]={(uint16)(32768*.743),(uint16)(32768*.882),(uint16)(32768*.653),(uint16)(32768*1.277),(uint16)(32768*.979),(uint16)(32768*.101),(uint16)(32768*.75)}; uint32 r,g,b;
 int x;
